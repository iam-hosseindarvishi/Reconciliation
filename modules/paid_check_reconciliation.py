...
"""
ماژول مغایرت‌گیری چک پرداختی
این ماژول مسئول پردازش و مغایرت‌گیری تراکنش‌های چک پرداختی است.
"""
...
class PaidCheckReconciliation:
    """
    کلاس مغایرت‌گیری چک پرداختی
    """
    ...
    def reconcile_paid_check(self, bank_record: Dict[str, Any], selected_bank_id: int) -> bool:
        """
